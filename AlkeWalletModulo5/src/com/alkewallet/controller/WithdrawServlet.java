...
/**
 * Controlador para retiro de fondos.
 * Cubre el requerimiento general: "realizar retiros de fondos".
 */
@WebServlet("/withdraw")
public class WithdrawServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            usuario.getAccount().withdraw(monto);
            request.getSession().setAttribute("mensaje", "Retiro realizado con éxito");
